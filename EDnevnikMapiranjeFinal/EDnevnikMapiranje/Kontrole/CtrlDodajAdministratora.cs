...
{
    public partial class CtrlDodajAdministratora : UserControl
    {
        public CtrlDodajAdministratora()
        {
            InitializeComponent();
        }
        ...
        private void CtrlDodajAdministratora_Load(object sender, EventArgs e)
        {
